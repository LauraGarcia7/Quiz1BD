...
<div class="container-fluid">
		...
		<div class="col-sm-6">
			...
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				<strong>Eror:</strong> Debe ingresar el nombre!
			</div>	
                    <%
                       }
                    %>
			...
			<div class="row">
                            ...
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                                    ...
                                                    <%
                                                       if(request.getAttribute("escuela")!=null){
                                                           Escuela escuela = (Escuela)request.getAttribute("escuela");
                                                           
                                                    %>
                                                    <form action="RegistroServlet?editar" method="POST">
                                                     <div class="form-group">
                                                         <input type="text" class="form-control" id="uid" name="codigo" value="<%=escuela.getCodigo()%>" placeholder="codigo" readonly="true">
                                                    </div>
                                                    <div class="form-group">
                                                            <input type="text" class="form-control" id="uid" name="nombre" value="<%=escuela.getNombre()%>" placeholder="Nombre">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                            <input type="text" class="form-control" id="uid" name="codigo" placeholder="Codigo">
                                                    </div>
                                                    <div class="form-group">
              ...
              <tbody>
                <%
                    if(request.getAttribute("lista")!=null){
                        ArrayList escuelas = (ArrayList<Escuela>)request.getAttribute("lista");
                        for (int i = 0; i < escuelas.size(); i++) {
                            Escuela escuela = (Escuela)escuelas.get(i);
                    %>
                      <tr>
                        <td><%=escuela.getCodigo()%></td>
                        <td><%=escuela.getNombre()%></td>
                        <td><a href="RegistroServlet?editar=<%=escuela.getCodigo()%>">Editar</a></td>
                        <td><a href="RegistroServlet?borrar=<%=escuela.getCodigo()%>">Borrar</a></td>
                     </tr>
                    <%
                        }
                    }
